document.addEventListener('DOMContentLoaded', function () {
    setTimeout(function () {
      ...
      descripcion.innerHTML = `
          <div class="accordion" id="accordionFisica">
              <div class="accordion-item">
                  ...
                  <div id="collapseFisicaI" class="accordion-collapse collapse" aria-labelledby="headingFisicaI" data-bs-parent="#accordionFisica">
              ...
              <div class="accordion-item">
                  ...
                  <div id="collapseFisicaII" class="accordion-collapse collapse" aria-labelledby="headingFisicaII" data-bs-parent="#accordionFisica">
                      <div class="accordion-body">
                          <ul>
